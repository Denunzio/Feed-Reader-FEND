...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('valid url defined on every entry', function()  {
    ...
    describe('Initial Entries', function()  {
        ...
        it('contain at least a single .entry element within the .feed container', function(done) {
            ...
            expect(entryElement).not.toBeUndefined();
    ...
    describe('New Feed Selection', function ()  {
         ...
         * Read a feed and store its content into a variable
         * Read a different feed and also store its content to a another variable
         * Compare the two variables expecting that they'll be different
         */
        beforeEach(function (done)  {
            $('.feed').empty();
            loadFeed(0, function()  {
            ...
            loadFeed(1, function()  {
                lastUrl = $('.feed').find(allFeeds.url);
                done();
            });
        });
